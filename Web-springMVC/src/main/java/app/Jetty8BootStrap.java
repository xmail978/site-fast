...
/**
 * @author WH
 * @ClassName: Jetty8BootStrap
 * @Description: Jetty8嵌入式启动
 * @date 2019-3-06 下午15:39:40
 */
public class Jetty8BootStrap {
...
//        String webAppPath = Jetty8BootStrap.class.getClassLoader().getResource(".").getFile();

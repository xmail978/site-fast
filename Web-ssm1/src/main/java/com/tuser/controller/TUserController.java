 ...
 * @version:
 * @Author: WH
 * @Date: 2019-10-09 09:50:26
 * @LastEditors: WH
 * @LastEditTime: 2019-10-09 09:50:26
 */
...
public class TUserController {
    ...
    public @ResponseBody
    TUser getUserInJson(@PathVariable String id, Map<String, Object> model) {
        int userId = Integer.parseInt(id);
        System.out.println("userId:" + userId);
        TUser user = this.userService.getUserById(userId);
    ...
    public ResponseEntity<TUser> getUserInJson2(@PathVariable String id, Map<String, Object> model) {
        int userId = Integer.parseInt(id);
        System.out.println("userId:" + userId);
        TUser user = this.userService.getUserById(userId);
        log.info(user.toString());
